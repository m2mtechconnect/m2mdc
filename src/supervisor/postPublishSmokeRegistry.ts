...
export const POST_PUBLISH_SMOKE_REGISTRY: readonly unknown[] = [
  {
    ...
    "observedSha": "1116358ef78caacac22a2eb347c2438c02297f19",
    "expectedSha": "e22ccbfd04cbc0c57df6749c6f37dab9aca41a82",
    "completedAt": "2026-09-12T19:21:05.219Z",
    "trigger": "automatic-on-publish",
    "artifactRef": "docs/evidence/post-publish-smoke/smoke-2026-09-12T19-21-05-219Z.json",
    ...
    "checks": [
      {
        ...
        "plane": "public",
        "status": "FAIL",
        "detail": "sha mismatch: expected e22ccbfd04cbc0c57df6749c6f37dab9aca41a82, got 1116358ef78caacac22a2eb347c2438c02297f19"
      },
      {
        "id": "public-shell:/",
        "plane": "public",
