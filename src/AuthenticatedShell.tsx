...
function ApprovedUserRoutes() {
  return (
    <Routes>
      ...
      <Route path="/teams/access-control" element={<PermissionRouteGuard permission="authz.manage_assignments"><PeopleAccessLayout><AccessControl /></PeopleAccessLayout></PermissionRouteGuard>} />
      <Route
