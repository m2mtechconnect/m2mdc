...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Caller identity is verified with the anon key before any privileged
    // client exists. The service-role client is constructed only after the
    // bearer token resolves to a real user.
