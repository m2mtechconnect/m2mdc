...
export const DSX_CAPABILITIES: DsxCapability[] = [
  ...
  },
  {
    ...
    owner: 'AURA',
    status: 'AURA_NATIVE',
    runtimeEvidence: 'src/search/platformSearchApi.ts',
    dataSource: 'Authorized AURA records',
    lastValidatedAt: '2026-08-18',
    validationMethod: 'unit-test',
    limitations: [
      'A product utility. Not a DSX component.',
      'Case-insensitive substring match over declared columns. No ranking, stemming or semantic retrieval.',
      'Searches facilities, agents, connections and simulation runs only. Row-level security decides what is returned.',
    ],
    blockers: [],
    nvidiaReference: null,
    nvidiaCodeOrServiceIntegrated: false,
