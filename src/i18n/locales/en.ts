...
const en = {
  ...
  blueprint: {
    ...
    back: 'Back',
    hideAssistant: 'AURA Assistant',
    showAssistant: 'AURA Assistant',
  ...
  search: {
    title: 'Search',
    subtitle: 'Find facilities, agents, connections and simulation runs you are authorized to see.',
    searchPlaceholder: 'Search facilities, agents, connections and runs...',
    searchButton: 'Search',
    latency: 'Query time',
    resultsFound: 'Records Found',
    recordTypesSearched: 'Record Types Searched',
    searching: 'Searching authorized records...',
    partialResults: 'Some record types could not be searched',
    failedTitle: 'Search failed',
    noResults: 'No records found',
    noResultsDesc: 'No record you are authorized to see matches this query. Try a different term or record type.',
    startSearching: 'Start searching',
    startSearchingDesc: 'Enter a query to search facilities, agents, connections and simulation runs.',
