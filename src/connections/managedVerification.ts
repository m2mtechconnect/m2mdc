 ...
 *
 * This module is the presentation mirror of
 * `supabase/functions/_shared/managedVerification.ts`. The server copy is the
 * authority; the unit suite keeps the two identical.
 */
